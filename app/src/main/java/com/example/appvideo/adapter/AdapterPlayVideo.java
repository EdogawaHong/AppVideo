...
public class AdapterPlayVideo extends RecyclerView.Adapter<AdapterPlayVideo.Viewhoder> {
    ...
    public AdapterPlayVideo(List<VideoInfo> videos, Context context) {
        this.videos = videos;
    ...
    public Viewhoder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.item_playvideo, parent, false);
    ...
    public class Viewhoder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public Viewhoder(@NonNull View itemView) {
            ...
            imgThumb = itemView.findViewById(R.id.imgItemPlayVideo);
